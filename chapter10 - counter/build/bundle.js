...
const CounterParent = __webpack_require__(27);

ReactDOM.render(React.createElement(
  'div',
  null,
  React.createElement(CounterParent, null)
...
class CounterParent extends React.Component {
    ...
    render() {
        ...
        return React.createElement(
            'div',
            { style: bgStyle },
            React.createElement(Counter, { display: this.state.count }),
            React.createElement(
                'button',
                { onClick: this.increase, style: btnStyle },
                '+'
            )
        );
    }
